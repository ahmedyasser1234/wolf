                                ...
                                <div className="relative flex flex-col md:flex-row justify-between items-start md:items-center gap-6 md:gap-4">
                                    ...
                                    {Object.entries(ORDER_STATUSES)
                                        ...
                                        .map(([key, status]) => {
                                            ...
                                            return (
                                                <div key={key} className="flex md:flex-col items-center gap-6 md:gap-4 group relative z-10">
                                                    <div className={`
                                                                    w-10 h-10 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl flex items-center justify-center transition-all duration-500
                                                                    ${isActive ? 'bg-primary text-black shadow-xl shadow-primary/20 scale-110' : 'bg-gray-900 text-gray-500 border-2 border-gray-800'}
                                                    ...
                                                    <div className={`flex flex-col md:items-center ${language === 'ar' ? 'text-right md:text-center' : 'text-left md:text-center'} min-w-0 flex-1`}>
                                                        ...
                                                        {isCurrent && (
                                                            <span className="text-[10px] sm:text-xs text-primary font-bold animate-pulse mt-1">
