  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "bg-white pointer-events-none block size-4 rounded-full shadow-lg ring-0 transition-transform data-[state=unchecked]:translate-x-0 ltr:data-[state=checked]:translate-x-4 rtl:data-[state=checked]:-translate-x-4 [dir=rtl]:data-[state=checked]:-translate-x-4"
        )}
      />
    </SwitchPrimitive.Root>
  );
